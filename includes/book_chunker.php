...
وظیفه تو: یک خلاصه جامع و ساختاریافته بنویس که شامل تمام اطلاعات مهم باشد.
...
### مفاهیم کلیدی:
- [تعریف‌ها و مفاهیم مهم — عیناً از کتاب]

### آیات و احادیث:
- [هر آیه یا حدیثی که در کتاب آمده، عیناً بنویس]
- [ترجمه آیات/احادیث رو هم بنویس]

### نکات مهم:
- [نکته‌های کلیدی، جعبه‌های «توجه»، «بیشتر بدانیم»، «پیام‌ها»]

### فعالیت‌ها و سوالات:
- [خلاصه فعالیت‌ها و سوالات خودارزیابی]

### خلاصه محتوا:
[یک پاراگراف خلاصه از کل درس]

## قوانین مهم:
1. آیات قرآنی و احادیث را کامل و عیناً بنویس (هم عربی هم ترجمه فارسی)
2. تعریف‌ها و اصطلاحات کلیدی را دقیق بنویس
3. هیچ اطلاعاتی اضافه نکن که در کتاب نیست
4. شماره صفحات مهم را اگر دیدی ذکر کن
5. اسامی خاص (پیامبران، امامان، شخصیت‌ها) را دقیق بنویس
6. فرمول‌ها را به LaTeX بنویس: $...$
7. جدول‌های مهم را حفظ کن
8. خروجی فقط فارسی باشه (اصطلاحات انگلیسی داخل پرانتز)
9. حداقل 2000 کلمه خروجی بده — جامع باش
PROMPT;
